...
Created on Fri May 29 12:16:06 2026
...
_mh_phys = 125.20   # GeV  — Higgs pole mass
...
class Standard_Model(generic_potential.generic_potential):
    ...
    def init(self,
        ...
        self.mu2  = 0.5 * mh**2          #(note: V0 = -mu2/2 phi^2 + ...)
